...
object SparkOnHBase {
  ...
  def main(args: Array[String]): Unit = {
    ...
    def convert(triple: (Int, String, Int)) = {
      ...
      (new ImmutableBytesWritable(Bytes.toBytes(triple._1)), p)
    }
    ...
    //添加过滤条件，年龄大于 18 岁
    val scan = new Scan()
    scan.setFilter(new SingleColumnValueExcludeFilter("basic".getBytes, "age".getBytes, CompareOp.GREATER_OR_EQUAL, Bytes.toBytes(18)))
